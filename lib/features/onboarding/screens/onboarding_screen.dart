                  ...
                  children: [
                    ...
                    LayoutBuilder(
                      builder: (context, constraints) {
                        ...
                        double spacing = 16;
                        double itemWidth =
                            (totalWidth - (crossCount - 1) * spacing) /
                                crossCount;
                        ...
                        return Wrap(
                          ...
                          children: step.options.entries.map((entry) {
                            final isSelected =
                                stepSelections.contains(entry.key);
                            return SizedBox(
                              width: itemWidth,
                              child: OnboardingItem(
                                ...
                                onTap: () {
                                  ref
                                      ...
                                      .toggleSelect(currentStep, entry.key);
                                },
                              ),
                            );
                          }).toList(),
                    ...
                    SizedBox(
                      ...
                      child: ElevatedButton(
                        onPressed: stepSelections.isNotEmpty
                            ? () async {
                                if (currentStep + 1 <
                                    OnboardingNotifier.steps.length) {
                                  setState(() {
                                    currentStep++;
                                  });
                                } else {
                        ...
                        style: ElevatedButton.styleFrom(
                          ...
                          backgroundColor: stepSelections.isNotEmpty
                              ? AppColors.primary
                              : AppColors.grey,
                        ),
                        child: Text(
                          currentStep == OnboardingNotifier.steps.length - 1
                              ? '완료'
                              : '다음',
                          style: const TextStyle(
